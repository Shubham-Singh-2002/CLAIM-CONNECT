...
public final class InsuranceClaimPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <div id=\"roomnav\" onclick=\"load()\">\n");
...
//                  }
//                  out.println(" </div>");
                  request.setAttribute("causeUrl","CauseServlet?id="+cdp.get(0).getClaimId());
                    out.println("<div id='claimhead'");
                    out.println("<h3>Claim Id</h3>");
                    out.println("<span>"+cdp.get(0).getClaimId()+"</span>");
                    out.println("</div>");
      ...
      out.write("          </div>\n");
      out.write("              <form id=\"cause\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${causeUrl}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\" method=\"post\">\n");
      out.write("              <div id=\"reasondiv\">\n");
      out.write("            <h4>Explain why you reverting this claim</h4>\n");
      out.write("            <textarea\n");
      out.write("              name=\"reason\"\n");
      out.write("              id=\"reason\"\n");
      out.write("              cols=\"20\"\n");
      out.write("              rows=\"2\"\n");
      out.write("              placeholder=\"reason here\"\n");
      out.write("            ></textarea>\n");
      out.write("          </div>\n");
      out.write("              </form>\n");
      out.write("              \n");
      ...
      out.write("            <div id=\"none\">\n");
      out.write("              <button class=\"button-57\" role=\"button\" id=\"revert\" onclick=\"submission()\">\n");
      out.write("                <span class=\"text\"\n");
      out.write("                  ><i class=\"ri-arrow-go-forward-line\"></i\n");
      out.write("                ></span>\n");
      out.write("                <span\n");
      ...
      out.write("      var revert = document.querySelector(\"#revert\");\n");
      out.write("      var none = document.querySelector(\"#none\");\n");
      out.write("      var data;\n");
      out.write("      textarea.addEventListener(\"keyup\", (e) => {\n");
      out.write("          e.preventDefault();\n");
      out.write("        // alert(\"+eifiej\");\n");
      out.write("        data = textarea.value;\n");
      out.write("        console.log(data);\n");
      out.write("        if (data.length !== 0) {\n");
      out.write("          none.style.cursor = \"hover\";\n");
      out.write("          revert.style.pointerEvents = \"visible\";\n");
      out.write("        }else{\n");
      out.write("          none.style.cursor = \"not-allowed\";\n");
      out.write("          revert.style.pointerEvents = \"none\";\n");
      out.write("        }\n");
      out.write("      });\n");
      ...
      out.write("        }\n");
      out.write("        \n");
      out.write("        var cause=document.querySelector(\"#cause\");\n");
      out.write("        function submission()\n");
      out.write("        {\n");
      out.write("            revert.addEventListener(\"click\",()=>{\n");
      out.write("                cause.submit();\n");
      out.write("            });\n");
      out.write("        }\n");
      out.write("            </script>\n");
      out.write("  </body>\n");
