    ...
    <div id="notifdiv">
      ...
      <div id="bottom">
        ...
        <%
            ...
            {
                request.setAttribute("disp","display-none");
                System.out.println("FrontEnd User Data not recieved");
            }
            else
            {
//                System.out.println("Cause ar frontend:"+cp.get(0).getCause());
                request.setAttribute("cause",cp.get(0).getCause());
                request.setAttribute("disp","display");
                System.out.println("User Data recieved");
                 request.setAttribute("InsComp",UserProfile.getCompName());
                 request.setAttribute("hospName",cp.get(0).getHospitalName());
            }
        %>
      ...
      <div id="details">
        <div id="from">
          <p>From:</p>
          <div class="det">
            <h4 class='${disp}'>${InsComp}</h4>
          </div>
        </div>
        <div id="to">
          <p>To:</p>
          <div class="det" >
            <h4 class='${disp}'>${hospName}</h4>
          </div>
        </div>
      </div>
      <div id="claimhead" class='${disp}' >
